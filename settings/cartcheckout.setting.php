...
return [
  ...
  'cartcheckout_civicrm_custom_pdfpapers_ft_id' => [
    'name' => 'cartcheckout_civicrm_custom_pdfpapers_ft_id',
    'type' => 'Integer',
    'html_type'  => 'select',
    'pseudoconstant' => [
    ...
    'is_domain'   => 1,
    'is_contact'  => 0,
    'title'       => E::ts('Financial Type for Paper Cart Items'),
    'description' => E::ts('Line item financial type to use for paper cart items.'),
    'settings_pages' => [
      'cart-checkout' => [
        'weight' => 10,
      ]
